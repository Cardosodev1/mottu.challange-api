CREATE TABLE tb_devices (
    ...
    CONSTRAINT fk_devices_yards FOREIGN KEY (id_yard) REFERENCES yards(id),
    CONSTRAINT fk_devices_motorcycles FOREIGN KEY (id_motorcycle) REFERENCES motorcycles(id)
